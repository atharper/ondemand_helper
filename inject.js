...
function main(dictionary) {
  ...
  $("li").each(function(i) {
    ...
    if (commit) {
      ...
      if (build != undefined)
      {
        build = build.replace("Development", "2017.11");
